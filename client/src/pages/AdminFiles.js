...
function AdminFiles() {
  ...
  const fetchFiles = async (query = "") => {
    try {
      const res = await fetch(
        `https://data-back-up-backened.onrender.com/api/admin/files?search=${query}`,
        {
          headers: {
  ...
  const deleteFile = async (id) => {
    ...
    await fetch(
      `https://data-back-up-backened.onrender.com/api/admin/file/${id}`,
      {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`
  ...
  const approveFile = async (id) => {
    await fetch(
      `https://data-back-up-backened.onrender.com/api/admin/approve/${id}`,
      {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`
  ...
  const rejectFile = async (id) => {
    await fetch(
      `https://data-back-up-backened.onrender.com/api/admin/reject/${id}`,
      {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`
